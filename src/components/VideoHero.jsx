...
export default function VideoHero() {
    // Temp YouTube travel video embed (you can swap the ID anytime)
    // NOTE: This is an embed, not <video>. Works reliably.
    const youtubeId = "Scxs7L0vhZ4"; // example travel video (change if you like)
        ...
        <section className="hero">
            ...
            <div className="heroOverlay">
                ...
                <div className="heroCtas">
                    <Link className="btn" to="/destinations">Explore destinations</Link>
                    <Link className="btn accent" to="/auth">Sign up / Login</Link>
                </div>
            </div>
        </section>
    );
